            ...
            <div class="col-12 col-sm-6 col-lg-4">
               ...
               <div class="my-3">
                    ...
                    <p class="font-14 fables-fifth-text-color mt-2 ml-4">Head office    <br>
                      ...
                      <b>Branches</b><br>
                       Nigeria, Ghana, South Africa</p><br>
                ...
                <div class="my-3">
                    ...
                    <p class="font-14 fables-fifth-text-color mt-2 ml-4">enquiries@enluka.org.uk</p>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-lg-4">
...
$currentYear = date("Y");
?>
        <p class="mb-0">Copyright © Enluka Consulting <?php echo $currentYear ?>. All rights reserved.</p> 
