    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-10 col-lg-9 pr-md-0">                       
                ...
                <a class="navbar-brand pl-0" href="index"><img src="assets/custom/images/enluka2.png" alt="Fables Template" class="fables-logo"></a>
                    ...
                    <div class="collapse navbar-collapse" id="fablesNavDropdown"> 
                                ...
                                <ul class="navbar-nav mx-auto fables-nav">   
                                    <li class="nav-item dropdown">
                                        <a class="nav-link" href="dev" id="sub-nav1" aria-haspopup="true" aria-expanded="false">
                                            Home
                                        </a>
                                    </li>

                                    <li class="nav-item dropdown">
                                        <a class="nav-link" href="about" id="sub-nav3" aria-haspopup="true" aria-expanded="false">
                                            About
                                        </a>
                                    </li>
